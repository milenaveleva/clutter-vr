	...
	: public TSharedFromThis<FKnotNodeCreation>
{
	...
	UK2Node_Knot* CreateKnotNode(FVector2f InKnotPos, UEdGraphPin* PreviousPin, UK2Node_Knot* KnotNodeToReuse, UEdGraph* Graph);
