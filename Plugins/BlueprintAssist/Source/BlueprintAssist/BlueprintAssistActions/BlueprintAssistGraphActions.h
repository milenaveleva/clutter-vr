...
public:
	...
	static void OpenContextMenu(const FVector2f& MenuLocation, const FVector2f& NodeSpawnPosition);
	static void OpenContextMenuFromPin(UEdGraphPin* Pin, const FVector2f& MenuLocation, const FVector2f& NodeLocation);
