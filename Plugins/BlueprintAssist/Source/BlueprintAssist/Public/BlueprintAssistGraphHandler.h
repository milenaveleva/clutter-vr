...
public:
	...
	void BeginLerpViewport(FVector2f TargetView, bool bCenter = true);
	const FVector2f& GetTargetLerpLocation() const { return TargetLerpLocation; }
