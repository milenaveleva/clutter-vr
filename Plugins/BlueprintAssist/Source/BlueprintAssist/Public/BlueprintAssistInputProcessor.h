...
public:
	...
	bool OnMouseDrag(FSlateApplication& SlateApp, const FVector2f& MousePos, const FVector2f& Delta);
	...
	void GroupMoveSelectedNodes(const FVector2f& Delta);
	void GroupMoveNodes(const FVector2f& Delta, TSet<UEdGraphNode*>& Nodes);
