...
struct FBAFormatterSettings
{
	...
	FBAFormatterSettings(FVector2f InPadding, EBAAutoFormatting InAutoFormatting, EEdGraphPinDirection InFormatterDirection, TArray<FName> InRootNodes = TArray<FName>())
		: Padding(InPadding)
	...
	UPROPERTY(EditAnywhere, config, Category=FormatterSettings, meta = (EditCondition = "bEnabled"))
	FVector2f Padding = FVector2f(100, 100);
...
public:
	...
	UPROPERTY(EditAnywhere, config, Category = BlueprintFormatting)
	FVector2f BlueprintParameterPadding;
