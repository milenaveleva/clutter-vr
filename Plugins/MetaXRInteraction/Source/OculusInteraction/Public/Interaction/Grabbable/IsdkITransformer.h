...
USTRUCT(
    BlueprintType,
    meta = (HasNativeMake = "/Script/OculusInteraction.IsdkFunctionLibrary.MakeGrabPoseStruct"))
...
USTRUCT(
    BlueprintType,
    meta = (HasNativeMake = "/Script/OculusInteraction.IsdkFunctionLibrary.MakeTargetTransformStruct"))
...
class OCULUSINTERACTION_API IIsdkITransformer
{
 ...
 public:
  ...
  /**
   * @brief Returns whether this transformer is currently active.
   */
