...
UDELEGATE(
    BlueprintType,
    Blueprintable,
    meta = (DisplayName = "Interactor Broadcasted Pointer Event Delegate"))
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(
    FIsdkInteractorBroadcastPointerEvent,
    const FIsdkInteractionPointerEvent&,
    BroadcastPointerEvent);
                                                       ...
                                                       public IIsdkIInteractorState
{
 ...
 public:
  ...
  /**
   * @brief Retrieves the delegate (by reference) that is broadcast when this interactor is passed a
   * pointer event
   * @return FIsdkInteractorBroadcastPointerEvent& Reference to the Delegate broadcast when this
   * interactor is passed a pointer event
   */
  FIsdkInteractorBroadcastPointerEvent& GetBroadcastPointerEventDelegate()
  {
    return BroadcastPointerEventDelegate;
  }

  void BroadcastPointerEvent(const FIsdkInteractionPointerEvent& PointerEvent)
  {
    BroadcastPointerEventDelegate.Broadcast(PointerEvent);
  }
 ...
 private:
  ...
  UPROPERTY(BlueprintAssignable, Category = InteractionSDK)
  FIsdkInteractorBroadcastPointerEvent BroadcastPointerEventDelegate;
