...
void UIsdkFromOpenXRHandDataSource::ReadHandData()
{
  EControllerHand Hand =
	...
	UHeadMountedDisplayFunctionLibrary::GetMotionControllerState(this, EXRSpaceType::XRTrackingSpace, Hand, EXRControllerPoseType::Grip,MotionControllerState);
	UHeadMountedDisplayFunctionLibrary::GetHandTrackingState(this, EXRSpaceType::XRTrackingSpace, Hand, HandTrackingState);
	
	if (MotionControllerState.bValid && !HandTrackingState.HandKeyLocations.IsEmpty())
  {
