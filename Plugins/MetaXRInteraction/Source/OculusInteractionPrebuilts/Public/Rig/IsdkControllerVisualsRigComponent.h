    ...
    : public UIsdkTrackedDataSourceRigComponent
{
 ...
 public:
   ...
   * originally derived from data but modified during runtime. For this class, a reference to the
   * SceneComponent associated with the procedural hand proxy used for the HandsOnlyProcedural
   * controller hand behavior is returned.
   *
  ...
  virtual void GetInteractorSocket(
      ...
      FName& OutSocketName,
      USceneComponent*& OutFollowComponent,
      EIsdkHandBones HandBone,
      EIsdkInteractionType InteractionType) const override;

  virtual EIsdkDeviceType GetDeviceType() const override
  {
    return EIsdkDeviceType::Controller;
  }

  virtual void SetFollowSocket(USceneComponent* FollowComponentIn, FName SocketNameIn) override;
