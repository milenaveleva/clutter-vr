...
void FIsdkDataSourcesMetaXRModule::StartupModule()
{
  ...
  lsdOculusXRModuleInstance = MakeUnique<FIsdkOculusXRModuleInstance>();
}
...
void FIsdkDataSourcesMetaXRModule::ShutdownModule()
{
  ...
  lsdOculusXRModuleInstance.Reset();
}
