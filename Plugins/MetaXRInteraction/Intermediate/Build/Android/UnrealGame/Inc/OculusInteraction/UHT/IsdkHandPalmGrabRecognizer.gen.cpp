...
// ********** Begin Delegate FIsdkPalmGrabRecognizerEventDelegate constinit property declarations **
// ********** End Delegate FIsdkPalmGrabRecognizerEventDelegate constinit property declarations ****
	static const UECodeGen_Private::FDelegateFunctionParams FuncParams;
};
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_OculusInteraction_IsdkPalmGrabRecognizerEventDelegate__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_OculusInteraction, nullptr, "IsdkPalmGrabRecognizerEventDelegate__DelegateSignature", 	nullptr, 
	0, 
0,
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UIsdkHandPalmGrabRecognizer_IsActive_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UIsdkHandPalmGrabRecognizer, nullptr, "IsActive", 	Z_Construct_UFunction_UIsdkHandPalmGrabRecognizer_IsActive_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_UIsdkHandPalmGrabRecognizer_IsActive_Statics::PropPointers), 
sizeof(Z_Construct_UFunction_UIsdkHandPalmGrabRecognizer_IsActive_Statics::IsdkHandPalmGrabRecognizer_eventIsActive_Parms),
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UIsdkHandPalmGrabRecognizer_IsActive_Statics::Function_MetaDataParams), Z_Construct_UFunction_UIsdkHandPalmGrabRecognizer_IsActive_Statics::Function_MetaDataParams)},  };
...
// ********** Begin Function SetPalmGrabMinFingerCurl constinit property declarations **************
	static const UECodeGen_Private::FFloatPropertyParams NewProp_Angle;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Function SetPalmGrabMinFingerCurl constinit property declarations ****************
	static const UECodeGen_Private::FFunctionParams FuncParams;
};

// ********** Begin Function SetPalmGrabMinFingerCurl Property Definitions *************************
...
// ********** End Function SetPalmGrabMinFingerCurl Property Definitions ***************************
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UIsdkHandPalmGrabRecognizer_SetPalmGrabMinFingerCurl_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UIsdkHandPalmGrabRecognizer, nullptr, "SetPalmGrabMinFingerCurl", 	Z_Construct_UFunction_UIsdkHandPalmGrabRecognizer_SetPalmGrabMinFingerCurl_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_UIsdkHandPalmGrabRecognizer_SetPalmGrabMinFingerCurl_Statics::PropPointers), 
sizeof(Z_Construct_UFunction_UIsdkHandPalmGrabRecognizer_SetPalmGrabMinFingerCurl_Statics::IsdkHandPalmGrabRecognizer_eventSetPalmGrabMinFingerCurl_Parms),
...
// ********** Begin Function SetPalmGrabMinFingers constinit property declarations *****************
	static const UECodeGen_Private::FIntPropertyParams NewProp_Count;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Function SetPalmGrabMinFingers constinit property declarations *******************
	static const UECodeGen_Private::FFunctionParams FuncParams;
};

// ********** Begin Function SetPalmGrabMinFingers Property Definitions ****************************
...
// ********** End Function SetPalmGrabMinFingers Property Definitions ******************************
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UIsdkHandPalmGrabRecognizer_SetPalmGrabMinFingers_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UIsdkHandPalmGrabRecognizer, nullptr, "SetPalmGrabMinFingers", 	Z_Construct_UFunction_UIsdkHandPalmGrabRecognizer_SetPalmGrabMinFingers_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_UIsdkHandPalmGrabRecognizer_SetPalmGrabMinFingers_Statics::PropPointers), 
sizeof(Z_Construct_UFunction_UIsdkHandPalmGrabRecognizer_SetPalmGrabMinFingers_Statics::IsdkHandPalmGrabRecognizer_eventSetPalmGrabMinFingers_Parms),
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UIsdkHandPalmGrabRecognizer_UpdateState_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UIsdkHandPalmGrabRecognizer, nullptr, "UpdateState", 	Z_Construct_UFunction_UIsdkHandPalmGrabRecognizer_UpdateState_Statics::PropPointers, 
	UE_ARRAY_COUNT(Z_Construct_UFunction_UIsdkHandPalmGrabRecognizer_UpdateState_Statics::PropPointers), 
sizeof(Z_Construct_UFunction_UIsdkHandPalmGrabRecognizer_UpdateState_Statics::IsdkHandPalmGrabRecognizer_eventUpdateState_Parms),
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UIsdkHandPalmGrabRecognizer_UpdateState_Statics::Function_MetaDataParams), Z_Construct_UFunction_UIsdkHandPalmGrabRecognizer_UpdateState_Statics::Function_MetaDataParams)},  };
...
// ********** Begin Class UIsdkHandPalmGrabRecognizer constinit property declarations **************
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End Class UIsdkHandPalmGrabRecognizer constinit property declarations ****************
	static constexpr UE::CodeGen::FClassNativeFunction Funcs[] = {
		{ .NameUTF8 = UTF8TEXT("IsActive"), .Pointer = &UIsdkHandPalmGrabRecognizer::execIsActive },
		{ .NameUTF8 = UTF8TEXT("SetPalmGrabMinFingerCurl"), .Pointer = &UIsdkHandPalmGrabRecognizer::execSetPalmGrabMinFingerCurl },
		{ .NameUTF8 = UTF8TEXT("SetPalmGrabMinFingers"), .Pointer = &UIsdkHandPalmGrabRecognizer::execSetPalmGrabMinFingers },
		{ .NameUTF8 = UTF8TEXT("UpdateState"), .Pointer = &UIsdkHandPalmGrabRecognizer::execUpdateState },
	};
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UIsdkHandPalmGrabRecognizer_IsActive, "IsActive" }, // 89370288
		{ &Z_Construct_UFunction_UIsdkHandPalmGrabRecognizer_SetPalmGrabMinFingerCurl, "SetPalmGrabMinFingerCurl" }, // 3924930639
		{ &Z_Construct_UFunction_UIsdkHandPalmGrabRecognizer_SetPalmGrabMinFingers, "SetPalmGrabMinFingers" }, // 4017206624
		{ &Z_Construct_UFunction_UIsdkHandPalmGrabRecognizer_UpdateState, "UpdateState" }, // 2969494286
	};
...
// ********** Begin Class UIsdkHandPalmGrabRecognizer Property Definitions *************************
...
// ********** End Class UIsdkHandPalmGrabRecognizer Property Definitions ***************************
...
void UIsdkHandPalmGrabRecognizer::StaticRegisterNativesUIsdkHandPalmGrabRecognizer()
{
	...
	FNativeFunctionRegistrar::RegisterFunctions(Class, MakeConstArrayView(Z_Construct_UClass_UIsdkHandPalmGrabRecognizer_Statics::Funcs));
}
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, UIsdkHandPalmGrabRecognizer);
UIsdkHandPalmGrabRecognizer::~UIsdkHandPalmGrabRecognizer() {}
// ********** End Class UIsdkHandPalmGrabRecognizer ************************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_ClutterVR_Plugins_MetaXRInteraction_Source_OculusInteraction_Public_HandPoseDetection_IsdkHandPalmGrabRecognizer_h__Script_OculusInteraction_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UIsdkHandPalmGrabRecognizer, UIsdkHandPalmGrabRecognizer::StaticClass, TEXT("UIsdkHandPalmGrabRecognizer"), &Z_Registration_Info_UClass_UIsdkHandPalmGrabRecognizer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UIsdkHandPalmGrabRecognizer), 3798927060U) },
	};
}; // Z_CompiledInDeferFile_FID_ClutterVR_Plugins_MetaXRInteraction_Source_OculusInteraction_Public_HandPoseDetection_IsdkHandPalmGrabRecognizer_h__Script_OculusInteraction_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ClutterVR_Plugins_MetaXRInteraction_Source_OculusInteraction_Public_HandPoseDetection_IsdkHandPalmGrabRecognizer_h__Script_OculusInteraction_2799071352{
	TEXT("/Script/OculusInteraction"),
	Z_CompiledInDeferFile_FID_ClutterVR_Plugins_MetaXRInteraction_Source_OculusInteraction_Public_HandPoseDetection_IsdkHandPalmGrabRecognizer_h__Script_OculusInteraction_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ClutterVR_Plugins_MetaXRInteraction_Source_OculusInteraction_Public_HandPoseDetection_IsdkHandPalmGrabRecognizer_h__Script_OculusInteraction_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0,
};
// ********** End Registration *********************************************************************
