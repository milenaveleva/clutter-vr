...
// IWYU pragma: private, include "StructTypes.h"

#ifdef OCULUSINTERACTION_StructTypes_generated_h
#error "StructTypes.generated.h already included, missing '#pragma once' in StructTypes.h"
#endif
#define OCULUSINTERACTION_StructTypes_generated_h
...
struct FIsdkDigitRecognizer_ExpectedAngleValueRange;
...
struct FIsdkDigitRecognizer_ExpectedDistanceValueRange;
...
struct FIsdkFilterPropertyBlock;
...
struct FIsdkFingerRecognizer_ExpectedFingerValueRanges;
...
struct FIsdkInteractableStateChangeArgs;
...
struct FIsdkInteractorStateChangeArgs;
...
struct FIsdkPokeInteractable_DragThresholdingConfig;
...
struct FIsdkPokeInteractable_MinThresholdsConfig;
...
struct FIsdkPokeInteractable_PositionPinningConfig;
...
struct FIsdkPokeInteractable_RecoilAssistConfig;
...
struct FIsdkPokeInteractor_SurfaceHitCache;
...
struct FIsdkRayInteractor_RayCandidateProperties;
...
struct FIsdkSyntheticHand_Config;
...
struct FIsdkThumbRecognizer_ExpectedThumbValueRanges;
...
#define FOREACH_ENUM_EISDKAXISALIGNEDBOX_BOXSIDE(op) \
	op(EIsdkAxisAlignedBox_BoxSide::Xmin) \
	op(EIsdkAxisAlignedBox_BoxSide::Xmax) \
	op(EIsdkAxisAlignedBox_BoxSide::Ymin) \
	op(EIsdkAxisAlignedBox_BoxSide::Ymax) \
	op(EIsdkAxisAlignedBox_BoxSide::Zmin) \
	op(EIsdkAxisAlignedBox_BoxSide::Zmax) 
...
#define FOREACH_ENUM_EISDKDATASOURCEUPDATEATTRIBUTERESULT(op) \
	op(EIsdkDataSourceUpdateAttributeResult::Unknown) \
	op(EIsdkDataSourceUpdateAttributeResult::Modified) \
	op(EIsdkDataSourceUpdateAttributeResult::NotModified) \
	op(EIsdkDataSourceUpdateAttributeResult::DoesNotExist) \
	op(EIsdkDataSourceUpdateAttributeResult::WrongValueType) 
...
#define FOREACH_ENUM_EISDKDATASOURCEUPDATEDATARESULT(op) \
	op(EIsdkDataSourceUpdateDataResult::Failure_InvalidPrevDataSource) \
	op(EIsdkDataSourceUpdateDataResult::Unknown) \
	op(EIsdkDataSourceUpdateDataResult::Modified) \
	op(EIsdkDataSourceUpdateDataResult::NotModified) 
...
#define FOREACH_ENUM_EISDKDETECTION_FINGERCALCTYPE(op) \
	op(EIsdkDetection_FingerCalcType::Curl) \
	op(EIsdkDetection_FingerCalcType::Flexion) \
	op(EIsdkDetection_FingerCalcType::Abduction) \
	op(EIsdkDetection_FingerCalcType::Opposition) \
	op(EIsdkDetection_FingerCalcType::Grab) \
	op(EIsdkDetection_FingerCalcType::OppositionTangentPlane) \
	op(EIsdkDetection_FingerCalcType::OppositionNormal) \
	op(EIsdkDetection_FingerCalcType::OppositionTopTwo) \
	op(EIsdkDetection_FingerCalcType::OppositionTopThree) 
...
#define FOREACH_ENUM_EISDKDETECTION_THUMBCALCTYPE(op) \
	op(EIsdkDetection_ThumbCalcType::Curl) \
	op(EIsdkDetection_ThumbCalcType::Flexion) 
...
#define FOREACH_ENUM_EISDKDIGITRECOGNIZER_UPDATERESULT(op) \
	op(EIsdkDigitRecognizer_UpdateResult::Failure) \
	op(EIsdkDigitRecognizer_UpdateResult::Unknown) \
	op(EIsdkDigitRecognizer_UpdateResult::Success) \
	op(EIsdkDigitRecognizer_UpdateResult::FrameDataUnavailable) \
	op(EIsdkDigitRecognizer_UpdateResult::FrameDataIsStale) 
...
#define FOREACH_ENUM_EISDKFINGERJOINT(op) \
	op(EIsdkFingerJoint::Metacarpal) \
	op(EIsdkFingerJoint::Proximal) \
	op(EIsdkFingerJoint::Intermediate) \
	op(EIsdkFingerJoint::Distal) \
	op(EIsdkFingerJoint::Tip) 
...
#define FOREACH_ENUM_EISDKFINGERTYPE(op) \
	op(EIsdkFingerType::Index) \
	op(EIsdkFingerType::Middle) \
	op(EIsdkFingerType::Ring) \
	op(EIsdkFingerType::Pinky) 
...
#define FOREACH_ENUM_EISDKHANDEDNESS(op) \
	op(EIsdkHandedness::Left) \
	op(EIsdkHandedness::Right) 
...
#define FOREACH_ENUM_EISDKINTERACTABLESTATE(op) \
	op(EIsdkInteractableState::Normal) \
	op(EIsdkInteractableState::Hover) \
	op(EIsdkInteractableState::Select) \
	op(EIsdkInteractableState::Disabled) 
...
#define FOREACH_ENUM_EISDKINTERACTORSTATE(op) \
	op(EIsdkInteractorState::Normal) \
	op(EIsdkInteractorState::Hover) \
	op(EIsdkInteractorState::Select) \
	op(EIsdkInteractorState::Disabled) 
...
#define FOREACH_ENUM_EISDKNORMALFACING(op) \
	op(EIsdkNormalFacing::Any) \
	op(EIsdkNormalFacing::In) \
	op(EIsdkNormalFacing::Out) 
...
#define FOREACH_ENUM_EISDKONEEUROHANDFILTER_ATTRIBUTEID(op) \
	op(EIsdkOneEuroHandFilter_AttributeId::Unknown) \
	op(EIsdkOneEuroHandFilter_AttributeId::WristPosBeta) \
	op(EIsdkOneEuroHandFilter_AttributeId::WristPosMinCutOff) \
	op(EIsdkOneEuroHandFilter_AttributeId::WristRotBeta) \
	op(EIsdkOneEuroHandFilter_AttributeId::WristRotMinCutOff) \
	op(EIsdkOneEuroHandFilter_AttributeId::FingerRotBeta) \
	op(EIsdkOneEuroHandFilter_AttributeId::FingerRotMinCutOff) \
	op(EIsdkOneEuroHandFilter_AttributeId::Frequency) \
	op(EIsdkOneEuroHandFilter_AttributeId::WristPosDeltaMinCutOff) \
	op(EIsdkOneEuroHandFilter_AttributeId::WristRotDeltaMinCutOff) \
	op(EIsdkOneEuroHandFilter_AttributeId::FingerRotDeltaMinCutOff) 
...
#define FOREACH_ENUM_EISDKPOINTEREVENTTYPE(op) \
	op(EIsdkPointerEventType::Hover) \
	op(EIsdkPointerEventType::Unhover) \
	op(EIsdkPointerEventType::Select) \
	op(EIsdkPointerEventType::Unselect) \
	op(EIsdkPointerEventType::Move) \
	op(EIsdkPointerEventType::Cancel) 
...
#define FOREACH_ENUM_EISDKSYNTHETICHAND_WRISTLOCKMODE(op) \
	op(EIsdkSyntheticHand_WristLockMode::Position) \
	op(EIsdkSyntheticHand_WristLockMode::Rotation) \
	op(EIsdkSyntheticHand_WristLockMode::Full) 
...
#define FOREACH_ENUM_EISDKTHUMBJOINT(op) \
	op(EIsdkThumbJoint::Metacarpal) \
	op(EIsdkThumbJoint::Proximal) \
	op(EIsdkThumbJoint::Distal) \
	op(EIsdkThumbJoint::Tip) 
