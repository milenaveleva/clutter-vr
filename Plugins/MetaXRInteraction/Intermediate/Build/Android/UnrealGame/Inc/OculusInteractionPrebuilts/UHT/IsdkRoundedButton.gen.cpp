...
OCULUSINTERACTIONPREBUILTS_API UClass* Z_Construct_UClass_AIsdkRoundedButton();
...
{
	using TClass = AIsdkRoundedButton;
	...
	return Z_Registration_Info_UClass_AIsdkRoundedButton.InnerSingleton;
}
UClass* Z_Construct_UClass_AIsdkRoundedButton_NoRegister()
{
	return AIsdkRoundedButton::GetPrivateStaticClass();
}
struct Z_Construct_UClass_AIsdkRoundedButton_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Class_MetaDataParams[] = {
		...
		{ "IncludePath", "IsdkRoundedButton.h" },
		{ "ModuleRelativePath", "Public/IsdkRoundedButton.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_RoundedButtonComponent_MetaData[] = {
...
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AIsdkRoundedButton_Statics::DependentSingletons) < 16);
const UECodeGen_Private::FClassParams Z_Construct_UClass_AIsdkRoundedButton_Statics::ClassParams = {
	&AIsdkRoundedButton::StaticClass,
	"Engine",
	&StaticCppClassTypeInfo,
	DependentSingletons,
	nullptr,
	Z_Construct_UClass_AIsdkRoundedButton_Statics::PropPointers,
	nullptr,
...
UClass* Z_Construct_UClass_AIsdkRoundedButton()
{
	...
	{
		UECodeGen_Private::ConstructUClass(Z_Registration_Info_UClass_AIsdkRoundedButton.OuterSingleton, Z_Construct_UClass_AIsdkRoundedButton_Statics::ClassParams);
	}
