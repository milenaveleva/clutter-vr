...
{
	using TClass = AOculusXRMR_CastingCameraActor;
	...
	return Z_Registration_Info_UClass_AOculusXRMR_CastingCameraActor.InnerSingleton;
}
UClass* Z_Construct_UClass_AOculusXRMR_CastingCameraActor_NoRegister()
{
	return AOculusXRMR_CastingCameraActor::GetPrivateStaticClass();
}
