...
struct Z_Construct_UClass_UMRUKDestructibleMeshComponent_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UDelegateFunction_UMRUKDestructibleMeshComponent_OnMeshesGenerated__DelegateSignature, "OnMeshesGenerated__DelegateSignature" }, // 202275699
	};
...
struct Z_Construct_UClass_AMRUKDestructibleGlobalMesh_Statics
{
	...
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_AMRUKDestructibleGlobalMesh_CreateDestructibleMesh, "CreateDestructibleMesh" }, // 2464229525
		{ &Z_Construct_UFunction_AMRUKDestructibleGlobalMesh_RemoveGlobalMeshSegment, "RemoveGlobalMeshSegment" }, // 2137135834
	};
	static_assert(UE_ARRAY_COUNT(FuncInfo) < 2048);
	static constexpr FCppClassTypeInfoStatic StaticCppClassTypeInfo = {
...
struct Z_Construct_UClass_AMRUKDestructibleGlobalMeshSpawner_Statics
{
	...
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_AMRUKDestructibleGlobalMeshSpawner_AddDestructibleGlobalMesh, "AddDestructibleGlobalMesh" }, // 3244244413
		{ &Z_Construct_UFunction_AMRUKDestructibleGlobalMeshSpawner_FindDestructibleMeshForRoom, "FindDestructibleMeshForRoom" }, // 3527314639
		{ &Z_Construct_UFunction_AMRUKDestructibleGlobalMeshSpawner_OnRoomCreated, "OnRoomCreated" }, // 4225364506
		{ &Z_Construct_UFunction_AMRUKDestructibleGlobalMeshSpawner_OnRoomRemoved, "OnRoomRemoved" }, // 157896472
	};
	static_assert(UE_ARRAY_COUNT(FuncInfo) < 2048);
	static constexpr FCppClassTypeInfoStatic StaticCppClassTypeInfo = {
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_OculusXR_release_HostProject_Plugins_OculusXR_Source_MRUtilityKit_Public_MRUtilityKitDestructibleMesh_h__Script_MRUtilityKit_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMRUKDestructibleMeshComponent, UMRUKDestructibleMeshComponent::StaticClass, TEXT("UMRUKDestructibleMeshComponent"), &Z_Registration_Info_UClass_UMRUKDestructibleMeshComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMRUKDestructibleMeshComponent), 1965502135U) },
		{ Z_Construct_UClass_AMRUKDestructibleGlobalMesh, AMRUKDestructibleGlobalMesh::StaticClass, TEXT("AMRUKDestructibleGlobalMesh"), &Z_Registration_Info_UClass_AMRUKDestructibleGlobalMesh, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMRUKDestructibleGlobalMesh), 1085459242U) },
		{ Z_Construct_UClass_AMRUKDestructibleGlobalMeshSpawner, AMRUKDestructibleGlobalMeshSpawner::StaticClass, TEXT("AMRUKDestructibleGlobalMeshSpawner"), &Z_Registration_Info_UClass_AMRUKDestructibleGlobalMeshSpawner, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMRUKDestructibleGlobalMeshSpawner), 1143907214U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_OculusXR_release_HostProject_Plugins_OculusXR_Source_MRUtilityKit_Public_MRUtilityKitDestructibleMesh_h__Script_MRUtilityKit_1708553420(TEXT("/Script/MRUtilityKit"),
	Z_CompiledInDeferFile_FID_OculusXR_release_HostProject_Plugins_OculusXR_Source_MRUtilityKit_Public_MRUtilityKitDestructibleMesh_h__Script_MRUtilityKit_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_OculusXR_release_HostProject_Plugins_OculusXR_Source_MRUtilityKit_Public_MRUtilityKitDestructibleMesh_h__Script_MRUtilityKit_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
