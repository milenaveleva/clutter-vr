...
FOculusBuildAnalytics* FOculusBuildAnalytics::BuildAnalyticsInstance = 0;

FOculusBuildAnalytics* FOculusBuildAnalytics::GetInstance()
{
	if (IOculusXRHMDModule::IsAvailable())
	{
		if (BuildAnalyticsInstance == nullptr)
		{
			BuildAnalyticsInstance = new FOculusBuildAnalytics();
		}
	}

	return BuildAnalyticsInstance;
}
