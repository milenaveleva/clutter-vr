...
{
	enum class OCULUSXRTELEMETRY_API EAction : short
	{
		Start = 1,
		Success = 2,
		Fail = 3,
	...
	class OCULUSXRTELEMETRY_API FTelemetryInstanceKey
	{
	public:
	...
	class OCULUSXRTELEMETRY_API FTelemetryTimestamp
	{
	...
	struct OCULUSXRTELEMETRY_API FEmptyBackend
	{
	...
	struct OCULUSXRTELEMETRY_API FQPLBackend
	{
