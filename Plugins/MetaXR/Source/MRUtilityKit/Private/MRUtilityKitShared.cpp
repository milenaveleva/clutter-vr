...
MRUKShared* MRUKShared::MRUKSharedInstance = nullptr;
...
void MRUKShared::LoadMRUKSharedLibrary()
{
	...
	MRUKSharedInstance = new MRUKShared(handle);
}
...
void MRUKShared::FreeMRUKSharedLibrary()
{
	...
	delete MRUKSharedInstance;
	MRUKSharedInstance = nullptr;
}
