...
public:
	...
	*/
	...
	/** Override version */
	UPROPERTY(config, EditAnywhere, Category = "Meta XR Simulator")
	bool bOverrideXRSimulatorVersion;

	/** Preferred version for XR Simulator */
	UPROPERTY(Config, EditAnywhere, Category = "Meta XR Simulator", meta = (EditCondition = "bOverrideXRSimulatorVersion", GetOptions = GetMetaXRSimulatorInstalledVersions, DisplayName = "Meta XR Simulator Version"))
	FString OculusXRSimulatorPreferredVersion;

	/** Skip following Simulator versions*/
	UPROPERTY(Config, EditAnywhere, Category = "Meta XR Simulator", meta = (DisplayName = "Skipped versions", EditCondition = "bOverrideXRSimulatorVersion"))
	TArray<FString> SkippedVersions;

	/** XR Simulator notification shown date*/
	UPROPERTY(config)
	FString XRSimNotificationShownDate;
