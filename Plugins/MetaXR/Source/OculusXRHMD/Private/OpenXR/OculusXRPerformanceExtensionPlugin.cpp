...
namespace OculusXR
{
	...
	void FPerformanceExtensionPlugin::InitializePerformanceMetrics(XrSession InSession)
	{
		...
		ENSURE_XRCMD(xrEnumeratePerformanceMetricsCounterPathsMETA.GetValue()(XRInstance, 0, &NumPerfMetricsCounterPaths, nullptr));
		PerfMetricsCounterPaths.SetNum(NumPerfMetricsCounterPaths);
		ENSURE_XRCMD(xrEnumeratePerformanceMetricsCounterPathsMETA.GetValue()(XRInstance, NumPerfMetricsCounterPaths, &NumPerfMetricsCounterPaths, PerfMetricsCounterPaths.GetData()));
