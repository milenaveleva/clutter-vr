...
TSharedPtr<FOculusXRStereoLayersFlagsSupplier> FOculusXRStereoLayersFlagsSupplier::StereoLayersFlagsSupplierInstance = NULL;

TSharedPtr<FOculusXRStereoLayersFlagsSupplier> FOculusXRStereoLayersFlagsSupplier::Get()
{
	if (!StereoLayersFlagsSupplierInstance.IsValid())
	{
		StereoLayersFlagsSupplierInstance = MakeShared<FOculusXRStereoLayersFlagsSupplier>();
	}

	return StereoLayersFlagsSupplierInstance;
}
